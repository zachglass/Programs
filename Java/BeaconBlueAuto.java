 ...
 */
@Disabled
@Autonomous(name="BeaconBlueAuto", group="Auto")
public class BeaconBlueAuto extends OpMode {
   ...
   // private Servo armRelease = null;
    ...
    //this makes it go right
        if (runtime.time() >= 9.85 && runtime.time() <= 11.85 ) {
            leftMotor1.setPower(-.5);
            leftMotor2.setPower(-.5);
            rightMotor1.setPower(.5);
            rightMotor2.setPower(.5);
    ...
    //this makes it go forward again
        if (runtime.time() >= 11.85 && runtime.time() <= 12.95 ) {
            leftMotor1.setPower(.5);
            leftMotor2.setPower(-.5);
            rightMotor1.setPower(.5);
            rightMotor2.setPower(-.5);
    ...
    //NEXT TIME WE GET ON THIS, THE TURNING STUFF IS WHAT WE NEED TO CHANGE AND EDIT AND STUFF
        if (runtime.time() >= 12.95 && runtime.time() <= 14.85 ) {
    ...
    //still going forward just slower than before
        if (runtime.time() >= 14.85 && runtime.time() <= 17.25 ) { //changed time values to not contradict if before it: they were not dones yet :)
    ...
    //this makes it go backwards
        if (runtime.time() >= 17.25 && runtime.time() <= 17.65 ) {
            leftMotor1.setPower(-.2);
            leftMotor2.setPower(-.2);
            rightMotor1.setPower(.2);
            rightMotor2.setPower(.2);
        }
        if (runtime.time() >= 17.65 && runtime.time() <= 18.15) {
        ...
        if (color.blue() >= 2 && runtime.time() >= 18.15 && runtime.time() <= 19.15 /*|| color0.blue() >= 2 && runtime.time() >= 10 && runtime.time() <= 12.5*/) {
            tracker = 1;
            keeper = 20;
        }
           ...
           /* leftMotor1.setPower(.5);
            ...
            if (runtime.time() >= 19.15 && runtime.time() <= 21.65) {
                ...
                if (runtime.time() >= 21.65 && runtime.time() <= 22.65 ) {
                leftMotor1.setPower(.2);
                leftMotor2.setPower(.2);
                rightMotor1.setPower(-.2);
                rightMotor2.setPower(-.2); // humped the second beacon once
            }
                if (runtime.time() >= 22.65 && runtime.time() <= 23.15 ) {
                    leftMotor1.setPower(-.2);
                    leftMotor2.setPower(-.2);
                    rightMotor1.setPower(.2);
                    rightMotor2.setPower(.2); // humped the second beacon once
                ...
                if (runtime.time() >= 23.15 && runtime.time() <= 23.65) {
                leftMotor1.setPower(0);
                leftMotor2.setPower(0);
                rightMotor1.setPower(0);
                rightMotor2.setPower(0);
            }
            if (color.red() >=2 /*|| color0.red() >=2*/) {
                if (runtime.time() >= 27.15 && runtime.time() <= 28.15) {
                    leftMotor1.setPower(.2);
                    leftMotor2.setPower(.2);
                    rightMotor1.setPower(-.2);
                    rightMotor2.setPower(-.2);
                }
                if (runtime.time() >= 28.15 && runtime.time() <= 28.2) {
                    leftMotor1.setPower(-.2);
                    leftMotor2.setPower(-.2);
                    rightMotor1.setPower(.2);
                    rightMotor2.setPower(.2);
                }
                if (runtime.time() >= 28.2 && runtime.time() <= 28.6) {
                    leftMotor1.setPower(0);
                    leftMotor2.setPower(0);
                    rightMotor1.setPower(0);
                    rightMotor2.setPower(0);
        ...
        } else if (color.red() >= 2 && runtime.time() >= 18.15 && keeper == 10 /*|| color0.red() >= 2 && runtime.time() >= 10 && keeper == 10*/) {
                tracker = 2;
        ...
        if (tracker == 2) {
            ...
            if (runtime.time() >= 23.15 && runtime.time() <= 24.15) {
                leftMotor1.setPower(.2);
                leftMotor2.setPower(.2);
                rightMotor1.setPower(-.2);
                rightMotor2.setPower(-.2);
            }
            if (runtime.time() >= 24.15 && runtime.time() <= 24.65) {
                leftMotor1.setPower(-.2);
                leftMotor2.setPower(-.2);
                rightMotor1.setPower(.2);
                rightMotor2.setPower(.2);
            }
            if (runtime.time() >= 17.5 && runtime.time() <= 19.9) {
                leftMotor1.setPower(0);
                leftMotor2.setPower(0);
                rightMotor1.setPower(0);
                rightMotor2.setPower(0);
            ...
            /*if (runtime.time() >= 19.9 && runtime.time() <= 21) { // this is temp stop once it hit first beacon twice
                leftMotor1.setPower(.2); // currently in front of second beacon
                leftMotor2.setPower(.2);
                rightMotor1.setPower(-.2);
                rightMotor2.setPower(-.2);
            }
            if (runtime.time() >= 21 && runtime.time() <= 21.5) {
                leftMotor1.setPower(-.2);
                leftMotor2.setPower(-.2);
                rightMotor1.setPower(.2);
                rightMotor2.setPower(.2);
            }
            if (runtime.time() >= 21.5 && runtime.time() <= 22.5) {
                leftMotor1.setPower(0);
                leftMotor2.setPower(0);
                rightMotor1.setPower(0);
                rightMotor2.setPower(0);
            ...
            if (color.red() >= 2 || color0.red() >= 2) {
                if (runtime.time() >= 26.5 && runtime.time() <= 27) {
                    leftMotor1.setPower(.2);
                    leftMotor2.setPower(.2);
                    rightMotor1.setPower(-.2);
                    rightMotor2.setPower(-.2);
                }
                if (runtime.time() >= 27 && runtime.time() <= 27.3) {
                    leftMotor1.setPower(-.2);
                    leftMotor2.setPower(-.2);
                    rightMotor1.setPower(.2);
                    rightMotor2.setPower(.2);
                }
                if (runtime.time() >= 27.3 && runtime.time() <= 28) {
                    leftMotor1.setPower(0);
                    leftMotor2.setPower(0);
                    rightMotor1.setPower(0);
                    rightMotor2.setPower(0);
...
//All this below isn't needed, we were just testing  and that didn't work and isn't apart of the
        //auto that works
       /* if (color.blue() >=2 && runtime.time() >= 10.7) { // this wont work yet...
        ...
        } else if (color.red() >=2 && runtime.time() >= 10.7 && runtime.time() <= 16) {
        ...
        if (color.red() >=2 && runtime.time() >= 16 && runtime.time() <= 17) {
        ...
        if (leftMotor1.getPower() == -.5 && runtime.time() >= 2 && runtime.time() <= 12) {
            leftMotor1.setPower(-.5);
            leftMotor2.setPower(.5);
            rightMotor1.setPower(-.5);
            rightMotor2.setPower(.5);

...
@Autonomous(name="Olympian Backup Auto With Delay", group="Auto")
public class OlympianBackupAutoDelayed extends OpMode {
    ...
    public void loop() {
        ...
        if (runtime.time() <= 10) {
            ...
            if (tracker == 0) /*Launching First Ball*/ {
                ...
                if (harvesterMotor.getCurrentPosition() <= 1800) {
            ...
            } else if (tracker == 2 && frontLeft.getCurrentPosition() <= 6600) { // Move away from corner
                moveForward();
            } else if (tracker == 2 && frontLeft.getCurrentPosition() >= 6600) { // Move left
                tracker = 3;
                moveLeft();
            } else if (tracker == 3 && frontLeft.getCurrentPosition() <= 2000) { // stop
                moveStop();
                tracker = 4;
            }
        }
